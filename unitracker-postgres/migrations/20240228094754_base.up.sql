...
comment on column discipline.title is 'Discipline title';
...
comment on column faculty.title is 'Full faculty title';
...
comment on column chair.title is 'Chair title';
...
comment on column student_group.title is 'Group title';
...
comment on column building.title is 'Building name';
...
comment on column auditorium.height is 'Auditorium height';

comment on column auditorium.length is 'Auditorium length';

comment on column auditorium.width is 'Auditorium width';
...
comment on column schedule.class_date is 'Date the class was held';
